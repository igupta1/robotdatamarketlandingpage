      ...
      <div className="relative z-20 text-center px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto">
        <div className="space-y-1">
          ...
          <h1 className="text-3xl md:text-5xl font-bold tracking-tight pb-2" style={{lineHeight: '1.2'}}>
            <span className="block text-white mb-2">The Marketplace for</span>
            <span className="block bg-gradient-to-r from-blue-400 via-cyan-400 to-green-400 bg-clip-text text-transparent pb-1">
