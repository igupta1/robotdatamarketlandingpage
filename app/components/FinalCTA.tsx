  ...
  return (
    <section className="py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        <div className="bg-gradient-to-br from-blue-900/30 via-purple-900/30 to-cyan-900/30 backdrop-blur-sm border border-gray-700 rounded-2xl p-8 md:p-12 text-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto leading-relaxed">
              Join thousands of developers, researchers, and companies using RoboData 
